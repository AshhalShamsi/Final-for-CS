...
public class Game
{
    ...
    private Wind wind;//creates a wind object with particles
    float lol;
    /**
    ...
    public void play() throws InterruptedException, IOException
    {
        ...
        while (env.getKey() != 1)
        {
            ...
            env.setDisplayStr("Score: " + score.getScore(),0,580);
            env.setDisplayStr("Shots: " + score.getShots(),0,560);
            env.setDisplayStr("Wind: " + lol,0,540);
            ...
            if(env.getKey() == 61)
            {
               if (!(score.getShots() >= 10))
               {
                   ...
                   boolean temp = ball1.throwBall(env,intensity.getIntensity(),lol);
                   wind.changeSpeed();
                   lol = wind.getSpeed();
     ...
     * @param double offX -- How far in the x direction you want to move the center of the circle
     *                       on which the ball travels.
